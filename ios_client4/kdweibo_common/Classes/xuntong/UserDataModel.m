...
//        }
        ...
        if (![language isKindOfClass:[NSNull class]] && language) {
            self.language = language;
        }
        id isVerify = [dict objectForKey:@"auth.verify.isopen"];
        if (![isVerify isKindOfClass:[NSNull class]] && isVerify) {
            self.isVerify = [isVerify integerValue];
        }
    }
    return self;
}
...
//        self.cloudpassport = [aDecoder decodeObjectForKey:@"cloudpassport"];
        ...
        self.isVerify = [[aDecoder decodeObjectForKey:@"isVerify"] integerValue];
