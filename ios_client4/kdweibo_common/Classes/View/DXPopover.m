...
@property (nonatomic, strong, readwrite) CustomControl *blackOverlay;
...
- (void)showAtPoint:(CGPoint)point
    ...
    if (!self.blackOverlay) {
        self.blackOverlay = [[CustomControl alloc] init];
...
- (void)drawRect:(CGRect)rect {
    ...
    UIColor *contentColor = [UIColor colorWithRGB:0x04142a];// self.contentColor;
