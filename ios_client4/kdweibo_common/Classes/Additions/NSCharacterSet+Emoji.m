//
//  NSCharacterSet+Emoji.m
//  KdWeiboIpad
//
//  Created by Snow Hellsing on 8/6/12.
...
static NSCharacterSet *emojiCharacterSet_;

@implementation NSCharacterSet (Emoji)

+ (NSCharacterSet *)emojiCharacterSet {
    if (emojiCharacterSet_ == nil) {
        NSMutableString *emojis = [[NSMutableString alloc] initWithData:[NSData dataWithBytes:emoji6 length:sizeof(emoji6)]
                                                 encoding:NSUTF16StringEncoding];
    
        // Add keyring character
        [emojis appendString:@"\u20e3"];
        
        emojiCharacterSet_ = [NSCharacterSet characterSetWithCharactersInString:emojis];// retain];
    
    }
    
    return emojiCharacterSet_;
}
