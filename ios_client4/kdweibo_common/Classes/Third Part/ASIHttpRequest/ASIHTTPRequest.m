...
- (void)buildRequestHeaders
{
     ...
     *  @modify-reason : client don't need cookie.
     */
...
//			[self setDefaultUserAgentString:[NSString stringWithFormat:@"%@ %@ (%@; %@ %@; %@)", appName, appVersion, deviceName, OSName, OSVersion, locale]];
            [self setDefaultUserAgentString:[NSString stringWithFormat:@"%@ (%@; %@ %@; %@)", appVersion, deviceName, OSName, OSVersion, locale]];
		}
...
{
	return ([[KDReachabilityManager sharedManager] reachabilityStatus] == KDReachabilityStatusReachableViaWWAN);	
}
