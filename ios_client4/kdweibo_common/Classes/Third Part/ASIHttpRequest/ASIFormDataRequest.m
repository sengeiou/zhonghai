...
{
//    filePath =@"/var/mobile/Containers/Data/Application/1BB9BFEB-2399-4833-8C6D-40F5A5089517/Library/Caches/Videos/Video/FAB50D368D014FB686BCEE6FBB091B6A.mp4";
	BOOL isDirectory = NO;
...
//        [self appendPostString:[NSString stringWithFormat:@"Content-Disposition: form-data; name=\"%@\"\r\n\r\n",[self encodeURL:[val objectForKey:@"key"]]]];
//		[self appendPostString:[self encodeURL:[val objectForKey:@"value"]]];
