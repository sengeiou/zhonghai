...
- (UIColor *)trackTintColor
{
    if (!_trackTintColor)
    {
        _trackTintColor = [UIColor colorWithRed:42/255.0 green:42/255.0 blue:42/255.0 alpha:0.8];// retain];
    }
...
- (UIColor *)progressTintColor
{
    ...
    {
        _progressTintColor = [UIColor colorWithRed:225/255.0 green:225/255.0 blue:225/255.0 alpha:1.0];// retain];
    }
