...
typedef void(^SDWebImageCompletedBlock)(UIImage *image, NSError *error, NSURL *url, SDImageCacheType cacheType);

typedef void(^SDWebImageCompletedWithFinishedBlock)(UIImage *image, NSError *error, NSURL *url, SDImageCacheType cacheType, BOOL finished);

typedef void(^SDWebImageCompletedWithFinishedBlockWithNSData)(UIImage *image, NSData *data, NSError *error, NSURL *url, SDImageCacheType cacheType, BOOL finished);
 ...
 * @endcode
 */
@property (strong) NSString *(^cacheKeyFilter)(NSURL *url, SDWebImageScaleOptions option);
