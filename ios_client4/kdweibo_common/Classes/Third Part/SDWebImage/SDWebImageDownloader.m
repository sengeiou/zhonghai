...
- (id)init {
    if ((self = [super init])) {
        ...
        [_HTTPHeaders setObject:@"deflate" forKey:@"Accept-Encoding"];
...
- (id <SDWebImageOperation>)downloadImageWithURL:(NSURL *)url
                                         options:(SDWebImageDownloaderOptions)options
                                           scale:(SDWebImageScaleOptions)scale
...
{
    return [self downloadImageWithURL:url options:options scale:SDWebImageScaleNone progress:progressBlock completed:completedBlock];
}
