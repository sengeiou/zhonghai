...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    CGFloat bottomBoundary = scrollView.contentSize.height + scrollView.contentInset.bottom - scrollView.bounds.size.height;

    BOOL isOverTopBoundary = currentOffsetY < topBoundary;
    BOOL isOverBottomBoundary = currentOffsetY >bottomBoundary;
    
    BOOL isBouncing = (isOverTopBoundary || isOverBottomBoundary) && scrollView.contentSize.height < scrollView.bounds.size.height;
    if (isBouncing || !_isDragging) {
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    _isDragging = YES;
    if ([_forwardTarget respondsToSelector:@selector(scrollViewWillBeginDragging:)]) {
        [_forwardTarget scrollViewWillBeginDragging:scrollView];
    }
