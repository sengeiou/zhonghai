//
//  KDALLColleagueViewController.m
//  kdweibo
//
...
@interface KDALLColleagueViewController ()<KDSearchBarDelegate, KDRefreshTableViewDelegate, KDRefreshTableViewDataSource, KDRequestWrapperDelegate>
...
@implementation KDALLColleagueViewController{
@private
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
        self.navigationItem.title = NSLocalizedString(@"AB_ALL_CONTACTS", @"");
        
        actionHelper_ = [[KDABPersonActionHelper alloc] initWithViewController:self];
        
        selectedTabIndex_                             = 0x01;
...
- (void)_search:(BOOL)firstPage {
    ...
    __block KDALLColleagueViewController *pvc = self ;//retain];
