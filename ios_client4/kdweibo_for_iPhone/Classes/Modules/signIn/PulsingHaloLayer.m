...
- (void)removeAllEffectAnimationWithDistance:(CGFloat)distance
{
    self.masksToBounds = YES;
    self.cornerRadius = distance;
    self.opacity = 0.45;
    [self.effect removeAllAnimations];
    self.bounds = CGRectMake(0, 0, distance*2, distance*2);
}

- (void)replicateEffectRefrence{
    self.opacity = 1;
