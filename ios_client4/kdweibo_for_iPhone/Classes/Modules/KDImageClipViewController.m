...
@interface KDImageClipViewController ()
...
@implementation KDImageClipViewController
...
- (void)initControlBtn {
    ...
    [confirmBtn setTitle:ASLocalizedString(@"Global_Sure") forState:UIControlStateNormal];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(KDImageClipDelegate)]) {
